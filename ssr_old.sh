...
JQ_install(){
	...
	if [[ -z ${JQ_ver} ]]; then
		...
		wget --no-check-certificate -N "https://raw.githubusercontent.com/ihomelp07/doubi/master/other/jq-1.5.tar.gz"
...
BanBTPTSPAM(){
	wget -4qO- raw.githubusercontent.com/ihomelp07/doubi/master/Get_Out_Spam.sh | bash
}
InstallBBR(){
